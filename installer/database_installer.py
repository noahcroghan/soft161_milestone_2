...
def add_starter_data(session):
    ...
    for coin_details in coins_list:
        session.add(
            Cryptocurrency(name=coin_details['id'], symbol=coin_details['symbol'], current_price=coin_details['current_price'], percent_change_24h=coin_details['price_change_percentage_24h']))


    HistoricalPrice(date=date(2025, 4, 14), price=51000.00)
